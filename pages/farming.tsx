        ...
        <main className="py-16">
          <div className="flex flex-col md:flex-row items-center md:justify-between max-w-5xl mx-auto gap-4 mb-16">
            <div className="max-w-md mx-auto md:max-w-none flex-1">
              <h1 className="text-4xl text-center md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-[#6AA0BF] to-[#D60040]">
                Staking LP to Earn ARB
                <br className="hidden xl:block" />& Lucky Chests
              </h1>
            </div>
          </div>
